...
from v1.models import CFGOVPage, LandingPage, CFGOVPageManager
...
class AskResultsPage(FilterableFeedPageMixin, FilterableListMixin, CFGOVPage):
...
class AnswerAudiencePage(FilterableFeedPageMixin, FilterableListMixin, CFGOVPage):
    ...
    def get_context(self, request, *args, **kwargs):
        ...
        for a in Answer.objects.all():
            for key in a.audiences.all():
                if str(key) == str(page_audience):
                    answers.append((a.slug, a.question))
